...
<html lang="en">
    <head>
        <title>TOKLINE | Toko Online</title>
        <!-- Required meta tags -->
        <!-- CSRF Token -->
        <meta name="csrf-token" content="{{ csrf_token() }}">
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <meta content="TOKLINE Toko Online Dengan Pengalaman Belanja Ala Mall" name="description">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md navbar-custom shadow-sm py-3 fixed-top">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}"><b>TOKLINE</b></a>
        ...
        <div class="footer">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <h4>Ikuti Kami</h4>
                        <a href="#" class="text-terhubung"><i class="fa-brands fa-facebook"></i></a>
                        <a href="#" class="text-terhubung"><i class="fa-brands fa-instagram"></i></a>
                        <a href="#" class="text-terhubung"><i class="fa-brands fa-twitter"></i></a>
                        <a href="#" class="text-terhubung"><i class="fa-brands fa-youtube"></i></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="copyright">
            <div class="container text-center">
                TOKLINE &copy; <?= date('Y');?>
                <br>
                Toko Online Dengan Pengalaman Belanja Ala Mall.
            </div>
        </div>
        <!-- end footer -->
        <!-- modal cari -->
